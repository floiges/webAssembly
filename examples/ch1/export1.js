...
function integrateWasmJS() {
  var wasmBinaryFile = 'export1.wasm';
...
var real__show_me_the_answer = asm["_show_me_the_answer"]; asm["_show_me_the_answer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__show_me_the_answer.apply(null, arguments);
};
...
var _show_me_the_answer = Module["_show_me_the_answer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_show_me_the_answer"].apply(null, arguments) };
