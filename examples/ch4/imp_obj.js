...
function integrateWasmJS() {
  var wasmBinaryFile = 'imp_obj.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _ButtonCreate() {
          return js_ButtonCreate();
      }

  function _ButtonRelease(button_id) {
  		return js_ButtonRelease(button_id);
  	}

  function _ButtonSetInnerHtml(button_id, str) {
...
Module["asm"] = asm;
var _PopButton = Module["_PopButton"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_PopButton"].apply(null, arguments) };
var _PushButton = Module["_PushButton"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_PushButton"].apply(null, arguments) };
