...
function integrateWasmJS() {
  var wasmBinaryFile = 'exp_class.wasm';
...
Module['wasmTableSize'] = 133;

Module['wasmMaxTableSize'] = 133;
...
var real__Sum_Delete = asm["_Sum_Delete"]; asm["_Sum_Delete"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__Sum_Delete.apply(null, arguments);
};

var real__Sum_Inc = asm["_Sum_Inc"]; asm["_Sum_Inc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__Sum_Inc.apply(null, arguments);
};

var real__Sum_New = asm["_Sum_New"]; asm["_Sum_New"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__Sum_New.apply(null, arguments);
};
...
Module["asm"] = asm;
var _Sum_Delete = Module["_Sum_Delete"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_Sum_Delete"].apply(null, arguments) };
var _Sum_Inc = Module["_Sum_Inc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_Sum_Inc"].apply(null, arguments) };
var _Sum_New = Module["_Sum_New"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_Sum_New"].apply(null, arguments) };
