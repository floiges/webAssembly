...
function integrateWasmJS() {
  var wasmBinaryFile = 'type_conv.wasm';
...
var ASM_CONSTS = [function() { console.log('你好，Emscripten！') },
 function($0, $1, $2) { return $0 + $1 + $2; },
 function($0, $1) { console.log("arguments count:", arguments.length); for (var i = 0; i < arguments.length; i++) { console.log('$', i, ':', arguments[i]); } },
 function() { return 42 },
 function() { return 3.14159 }];
...
var STATIC_BUMP = 6064;
Module["STATIC_BASE"] = STATIC_BASE;
Module["STATIC_BUMP"] = STATIC_BUMP;

/* no memory initializer */
var tempDoublePtr = 7072
...
var real__print_double = asm["_print_double"]; asm["_print_double"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__print_double.apply(null, arguments);
};

var real__print_float = asm["_print_float"]; asm["_print_float"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__print_float.apply(null, arguments);
};

var real__print_int = asm["_print_int"]; asm["_print_int"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__print_int.apply(null, arguments);
};
...
var _print_double = Module["_print_double"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_print_double"].apply(null, arguments) };
var _print_float = Module["_print_float"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_print_float"].apply(null, arguments) };
var _print_int = Module["_print_int"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_print_int"].apply(null, arguments) };
